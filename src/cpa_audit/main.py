...
def main():
    ...
    year_ls = ["H31_2", "R2_1", "R2_2", "R3"]#, "R4_1", "R4_2", "R5_1", "R5_2"]
    ...
    for main_model_name in model_ls:
        for subject in subject_ls:
            for is_rag in is_rag_ls:
                cpa.inference(subject=subject, year_set=year_ls, llama_model_path=model_path, main_model_name=main_model_name, is_rag=is_rag, sub_model_name=sub_model_name)
